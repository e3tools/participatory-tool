...
class EngagementForm(Document):
	...
	def _get_docfield(self, form_field: EngagementFormField):
		...
		if form_field.field_type == 'Linked Field':
			is_table, trigger_field_name, trigger_field_doctype, trigger_field_grid_name, trigger_field_grid_doctype, target_field = self.is_linked_field_a_child_table(form_field)
			if is_table:
	...
	def is_linked_field_a_child_table(self, field) -> tuple[bool, str, str, str, str, str]:
		...
		parent_field = [x for x in self.form_fields if x.field_name == field.linked_form]
		...
		docfield = docfield[0]
		return docfield.fieldtype == 'Table', parent_field.field_name, parent_field.field_doctype, field.linked_form_property, docfield.options, field.field_name
	...
	def get_linked_field_field_type(self, field): 
		...
		"""  
		is_table, trigger_field_name, trigger_field_doctype, trigger_field_grid_name, trigger_field_grid_doctype, target_field = self.is_linked_field_a_child_table(field)
		if is_table:
			return 'Table'
		return 'Read Only'
	...
	def handle_child_table_read_only_field(self, field: EngagementFormField):
		...
		def _make_client_script(trigger_field: str, trigger_field_doctype: str, trigger_field_table_property: str, target_field: str):
